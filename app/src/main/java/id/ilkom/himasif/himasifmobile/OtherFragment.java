...
public class OtherFragment extends Fragment {
    ...
    CardView visimisi, tentang_kami, pengurus, aspirasi;
    Class<VisiMisi> visiMisiClass;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        visimisi = (CardView)view.findViewById(R.id.visimisi);
        ...
        tentang_kami = (CardView) view.findViewById(R.id.tentang_kami);
        ...
        pengurus = (CardView) view.findViewById(R.id.pengurus);
        ...
        aspirasi = (CardView) view.findViewById(R.id.aspirasi);
